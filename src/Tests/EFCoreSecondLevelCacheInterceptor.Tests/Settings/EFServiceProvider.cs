    ...
    public static IEFCacheServiceProvider GetCacheServiceProvider(TestCacheProvider provider)
    {
        ...
        switch (provider)
        {
            ...
            case TestCacheProvider.EasyCachingCoreHybrid:
                ...
                services.AddEFSecondLevelCache(options => options.UseEasyCachingCoreProvider(providerName3, true));
        ...
        services.AddEFSecondLevelCache(options =>
                                       {
                                           switch (cacheProvider)
                                           {
                                               ...
                                               case TestCacheProvider.EasyCachingCoreHybrid:
                                                   const string providerName3 = "Hybrid1";
                                                   options.UseEasyCachingCoreProvider(providerName3, true);
                                                   addEasyCachingCoreHybrid(services, providerName3);
                                                   break;
                                           }
                                           ...
                                           if (cacheAllQueries)
                                           {
                                               options.CacheAllQueries(CacheExpirationMode.Absolute,
        ...
        services.AddEasyCaching(option =>
                                {
                                    option.UseRedis(config =>
                                          ...
                                          .WithRedisBus(busConf =>
                                                        {
                                                            busConf.Endpoints
                                                                   .Add(new ServerEndPoint("127.0.0.1", 6379));
                                                            // busConf.Database = 2;
